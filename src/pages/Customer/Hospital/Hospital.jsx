...
To use local images in your React carousel, you'll need to import them directly into your component. Here’s how you can update the previous example to use local images
</p>
          <div className="hospital-hero-containerfirst2">
            <div className="flex hospital-hero-containerfirst21">          
                <div>
                   <CountingEffect targetNumber={5000} duration={3000} prefix="+" style={{ color: 'green' }} />
                  <h3>Hospitals</h3>
                </div>
                <div>
                <CountingEffect targetNumber={40} duration={3000} prefix="+" style={{ color: '#f43f5e' }} />
                  <h3>Specialities</h3>
                </div>
                <div>
                <CountingEffect targetNumber={3000} duration={3000} prefix="+" style={{ color: '#7c3aed' }} />
                  <h3>Hospitals</h3>
                </div>
            </div>
            <button onClick={SearchHostpital} >Search Hospitals <i class="ri-arrow-right-up-line"></i></button>
          </div>
...
<div className="imageset">
  ...
  <div className="container">
          ...
          <div className="second-main-head">
            <h1>
              Find Hospital by <span className="color-blue">Specialities </span>
            </h1>
          </div>

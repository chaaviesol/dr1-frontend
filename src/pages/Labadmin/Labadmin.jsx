        ...
        <div className="hospitaladmin_right">
          ...
          <div className="manage flex">
            ...
            <div className="hospitaladmin_cards flex">
              <div className="hospitaladmin_card hospitaladmin_card1 flex">
                <div>
              ...
              <div className="hospitaladmin_card hospitaladmin_card2 flex">
                <div>
              ...
              <div className="hospitaladmin_card hospitaladmin_card3 flex">
                <div>
